...
import { BadRequestError } from 'jobber-shared-for-hkhanq';
import { Request, Response } from 'express';
import { gigCreate } from '@gig/controller/create';
import * as helper from 'jobber-shared-for-hkhanq';
import * as gigService from '@gig/services/gig.service';
import { authUserPayload, gigMockRequest, gigMockResponse, sellerGig } from '@gig/controller/test/mocks/gig.mock';
...
describe('Gig Controller', () => {
  ...
  describe('gig method', () => {
    it('should throw an error for invalid schema data', () => {
        const temp = gigMockRequest({}, sellerGig, authUserPayload) as unknown;
        const req = temp as Request;
